...
<div align="center">
  ...
  <div class="img-upload important" id="instructions" style="width:75%;"><s:text name="uploadReportFiles.uploadFile"/></div>
  ...
  <div class="img-report important" id="files" style="width:75%"><s:text name="uploadReportFiles.currentFiles"/></div>
