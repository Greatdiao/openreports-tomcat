	...
	public JasperPrint fillReport(ReportEngineInput input) throws ProviderException
	{
		...
		try
		{
			...
			jr = (JasperReport) JRLoader
					.loadObjectFromFile(directoryProvider.getReportDirectory() + report.getFile());
			...
			if (subReports != null && subReports.size() > 0)
			{
				...
				while (iterator.hasNext())
				{
					...
					JasperReport subReport = (JasperReport) JRLoader.loadObjectFromFile(directoryProvider
							.getReportDirectory()
